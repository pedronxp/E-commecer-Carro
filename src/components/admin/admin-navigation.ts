...
export const ADMIN_NAV_ITEMS: AdminNavItem[] = [
  ...
  { href: "/admin/promotions", label: "Precificador sem cadastro", icon: BadgePercent },
...
const ADMIN_ROUTE_TITLES: Array<{ match: (pathname: string) => boolean; title: string }> = [
  ...
  { match: (pathname) => pathname.startsWith("/admin/promotions"), title: "Precificador sem cadastro" },
