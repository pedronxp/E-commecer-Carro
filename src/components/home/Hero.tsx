...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-emerald-700 via-emerald-600 to-secondary px-4 py-24 text-white sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="max-w-2xl">
          ...
          >
            Encontre o carro <br />
            <span className="text-emerald-300">ideal para você</span>
          </h1>
