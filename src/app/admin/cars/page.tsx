      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="text-left px-6 py-4 text-sm font-medium text-gray-500">Imagem</th>
              <th className="text-left px-6 py-4 text-sm font-medium text-gray-500">Título</th>
              <th className="text-left px-6 py-4 text-sm font-medium text-gray-500">Marca</th>
              <th className="text-left px-6 py-4 text-sm font-medium text-gray-500">Ano</th>
          ...
          <tbody className="divide-y divide-gray-100">
            {cars.map((car) => (
              <tr key={car.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-gray-600">{car.brand.name}</td>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <form action={deleteCar}>
                      ...
                      <button
                        ...
                        onClick={(e) => {
                          if (!confirm("Excluir este carro?")) e.preventDefault();
                        }}
                        title="Excluir"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
